...
public class RemoteEntities extends JavaPlugin
{
	...
	private static String COMPATIBLE_VERSION = "1.7.10";
	private static String COMPATIBLE_REVISION = "v1_7_R4";
	...
	void checkConfig()
	{
		...
		COMPATIBLE_REVISION = this.getConfig().getString("COMPATIBLE_REVISION", "v1_7_R4");
		COMPATIBLE_VERSION = this.getConfig().getString("COMPATIBLE_VERSION", "1.7.10");
		this.saveConfig();
	}
